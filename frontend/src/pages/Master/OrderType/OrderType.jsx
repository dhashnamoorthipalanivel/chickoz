...
const initialData = [
    ...
    {
        id: 4,
        orderTypeCode: "ONLINE",
        orderTypeName: "Online Order",
        shortName: "ON",
        serviceChargeApplicable: false,
        status: "INACTIVE",
    },
...
const OrderType = () => {
    ...
    // Fetch order type data from store
    ...
    const filtered = orderTypes.filter((item) => {
        const matchSearch =
            item.orderTypeName.toLowerCase().includes(search.toLowerCase()) ||
            item.orderTypeCode.toLowerCase().includes(search.toLowerCase()) ||
                    ...
                    <div className="row">
                        <div className="col-12">
                            <div className="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h4 className="mb-sm-0 font-size-18">Order Type Management</h4>
                                ...
                                <div className="card-header">
                                    <div className="d-flex align-items-center justify-content-between flex-wrap gap-2">
                                        ...
                                        <div className="d-flex gap-2">
                                            ...
                                            <Link to="/master-order-type/add" className="btn btn-sm btn-primary">
                                                <i className="bx bx-plus me-1"></i> Add Order Type
                                            </Link>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div className="col-sm-12 col-md-6">
                                            <div className="position-relative">
                                                <input
                                                    ...
                                                    placeholder="Search by order type name, code or short name..."
                                                    value={search}
                                                    onChange={(e) => {
                                                ...
                                                {paged.length === 0 ? (
                                                    ...
                                                    paged.map((row, index) => (
                                                        ...
                                                        >
                                                            ...
                                                            <td>{row.shortName}</td>
                                                            <td>{yesNoBadge(row.serviceChargeApplicable)}</td>
                                                            <td>{statusBadge(row.status)}</td>

                                                            <td>
                                                                <div className="d-flex justify-content-center gap-2">
                                                                    <Link
                                                                        to={`/master-order-type/edit/${row._id}`}
                                                                        state={{ rowData: row }}
                    ...
                    <div className="modal-dialog modal-dialog-centered">
                        <div className="modal-content">
                            ...
                            <div className="modal-body text-center pb-4">
                                ...
                                <h5>Delete Order Type?</h5>
                                <p className="text-muted mb-0">
                                    Are you sure you want to delete this order type? This action cannot
                                    be undone.
                                </p>
                            </div>
