...
const PaymentMode = () => {
  ...
  const filtered = paymentModes.filter((item) => {
    const matchSearch =
      item.paymentName.toLowerCase().includes(search.toLowerCase()) ||
      item.paymentCode.toLowerCase().includes(search.toLowerCase()) ||
          ...
          <div className="row">
            <div className="col-12">
              <div className="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 className="mb-sm-0 font-size-18">Payment Mode Management</h4>
                ...
                <div className="card-header">
                  <div className="d-flex align-items-center justify-content-between flex-wrap gap-2">
                    ...
                    <div className="d-flex gap-2">
                      ...
                      <Link to="/master-payment-mode/add" className="btn btn-sm btn-primary">
                    ...
                    <div className="col-sm-12 col-md-5">
                      <div className="position-relative">
                        <input
                          ...
                          placeholder="Search by payment name, code or type..."
                          value={search}
                          onChange={(e) => {
                        ...
                        {paged.length === 0 ? (
                          ...
                          paged.map((row, index) => (
                            ...
                            >
                              ...
                              <td>{formatLabel(row.paymentType)}</td>
                              <td>{statusBadge(row.status)}</td>

                              <td>
                                <div className="d-flex justify-content-center gap-2">
                                  <Link
                                    to={`/master-payment-mode/edit/${row._id}`}
                                    state={{ rowData: row }}
          ...
          <div className="modal-dialog modal-dialog-centered">
            <div className="modal-content">
              ...
              <div className="modal-body text-center pb-4">
                ...
                <h5>Delete Payment Mode?</h5>
                <p className="text-muted mb-0">
                  Are you sure you want to delete this payment mode? This action cannot
                  be undone.
                </p>
              </div>
