                    ...
                    <div className="row">
                        <div className="col-12">
                            <div className="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h4 className="mb-sm-0 font-size-18">Invoice Detail</h4>
                                ...
                                <div className="card-body">
                                    ...
                                    <div className="d-print-none mt-3">
                                        <div className="float-end">
                                            <a href="#" onClick={() => window.print()} className="btn btn-success waves-effect waves-light me-1"><i className="fa fa-print"></i></a>
