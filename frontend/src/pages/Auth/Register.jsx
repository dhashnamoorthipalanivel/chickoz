              ...
              <div className="w-100">
                <div className="d-flex flex-column h-100">
                  ...
                  <div className="auth-content my-auto">
                    ...
                    <form className="needs-validation mt-4 pt-2" noValidate onSubmit={handleRegister}>
                      <div className="mb-3">
                    ...
                    <div className="mt-5 text-center">
                      <p className="text-muted mb-0">Already have an account ? <Link to="/auth-login" className="text-primary fw-semibold"> Login </Link> </p>
                    </div>
                  </div>
                      ...
                      <div className="carousel-inner">
                        <div className="carousel-item active">
                          <div className="testi-contain text-white">
                            ...
                            <h4 className="mt-4 fw-medium lh-base text-white">“I feel confident imposing change on myself.”</h4>
