...
import { updateRole, fetchRoleById } from '../../api/userManagementApi';
...
const EditRole = () => {
  ...
  useEffect(() => {
    ...
    // Fetch Role Data
    fetchRoleById(id).then(roleData => {
      setFormData({
        name: roleData.name || '',
        description: roleData.description || '',
        franchiseId: roleData.franchiseId || '',
          ...
          <div className="row">
            <div className="col-12">
              <div className="page-title-box">
                <h4 className="mb-0 font-size-18">Edit Role</h4>
              </div>
            </div>
          </div>
