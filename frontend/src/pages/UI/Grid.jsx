                    ...
                    <div className="row">
                        <div className="col-12">
                            <div className="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h4 className="mb-sm-0 font-size-18">Grid</h4>
                                            ...
                                            <div className="row align-items-center">
                                                <div className="col-sm-3">
                                                    <div className="grid-container mt-0">
                                                        <code>Level 1: col-sm-3</code>
                                                    </div>
                                                </div>
                                                <div className="col-sm-9">
                                                    <div className="grid-example mt-0">
                                                        <div className="row align-items-center">
                                                            <div className="col-12 col-sm-6">
                                                                <div className="grid-container mt-md-0">
                                                                    <code>Level 2: col-12 col-sm-6</code>
                                                                </div>
                                                            </div>
                                                            <div className="col-12 col-sm-6">
                                                                <div className="grid-container mt-md-0">
                            ...
                            <div class="card">
                                ...
                                <div className="card-body">
                                    ...
                                    <div className="mt-4">
                                        ...
                                        <div className="bg-light-subtle p-3 text-center">
                                            <div className="row" style={{ minHeight: '9rem' }}>
