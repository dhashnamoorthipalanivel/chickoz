...
const ALL_STATUSES = ["UNDER_REVIEW","APPROVED","DISPATCHED","DELIVERED","REJECTED"];
...
const MasalaAdminProcessView = () => {
  ...
  const handleStatusUpdate = async () => {
    ...
    try {
      const res = await updateRequestStatus(id, { status: selectedStatus, adminRemarks });
      if (res?.success) {
      ...
      <div className="page-content"><div className="container-fluid">
        ...
        <div className="row g-3 adm-ani">
          ...
          <div className="col-xl-4">
            ...
            {/* Admin Remarks (saved) */}
            {data.adminRemarks && (
              <div className="card" style={{ borderRadius:16, border:"1.5px solid #f3f4f6" }}>
